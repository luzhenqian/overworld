...
export const resources = {
  zh: {
    game: {
      ...
      'hud.talkHint': '按 E 交谈',
      'hud.currentObjective': '当前目标',
      'hud.gold': '金币',
      'hud.achievements': '成就',
      'hud.online': '在线玩家',
      'hud.switchLanguage': '切换语言',
      'hud.inventory': '快捷物品',
      'hud.emptySlot': '空物品栏',
      'hud.interact': '交互',
      'hud.talk': '与向导交谈',
  ...
  en: {
    game: {
      ...
      'hud.online': 'Players online',
      'hud.switchLanguage': 'Switch language',
      'hud.inventory': 'Quick items',
      'hud.emptySlot': 'Empty slot',
      'hud.interact': 'Interact',
      'hud.talk': 'Talk to the guide',
      'hud.location': 'Current location',
      'hud.move': 'Move',
      'hud.run': 'Run',
      'hud.action': 'Action',
      'hud.dialogue': 'Dialogue',
      'hud.conversation': 'In conversation',
      'hud.close': 'Close',

...
export default function sitemap(): MetadataRoute.Sitemap {
  const staticPages: MetadataRoute.Sitemap = [
    ...
    {
      url: absoluteUrl('/en/typescript-game-ai-navigation-system'),
      lastModified: englishLastModified,
      changeFrequency: 'monthly',
      priority: 0.8,
    },
    {
      url: absoluteUrl('/en/typescript-game-save-system'),
      lastModified: englishLastModified,
      changeFrequency: 'monthly',
      priority: 0.8,
    },
    ...
    {
      url: absoluteUrl('/en/react-three-fiber-game-performance'),
      lastModified: englishLastModified,
      changeFrequency: 'monthly',
      priority: 0.8,
    },
    {
      url: absoluteUrl('/en/react-three-fiber-npc-interaction'),
      lastModified: englishLastModified,
      changeFrequency: 'monthly',
      priority: 0.8,
    },
    ...
    {
      url: absoluteUrl('/en/typescript-rpg-content-validation'),
      lastModified: englishLastModified,
      changeFrequency: 'monthly',
      priority: 0.8,
    },

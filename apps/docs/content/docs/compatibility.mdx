---
title: 兼容性与支持范围
description: 运行时、peer 依赖、包管理器、平台边界与版本策略
---
...
# npm
npm install @overworld-engine/core @overworld-engine/quest zustand

# yarn
yarn add @overworld-engine/core @overworld-engine/quest zustand
```
